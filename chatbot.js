...
(function () {
  ...
  var ENTRIES = [
    ...
    { k: ["siapa", "tentang", "about", "who", "profil", "profile", "kenalan", "khairu", "orangnya", "dia siapa"],
      id: "Khairuramdhani (disapa Khai) adalah AI/ML Engineer, Mobile Developer, dan Mechanical Designer, serta mahasiswa Teknik Komputer di Universitas Brawijaya. Fokus dan minat utamanya adalah Computer Vision serta desain mekanik dan 3D, namun ia juga menguasai machine learning, data, IoT/embedded, dan mobile. Ia terbiasa menggunakan Python dan C++, mengembangkan aplikasi mobile dengan Flutter, serta mengerjakan proyek secara menyeluruh mulai dari data hingga penerapannya pada perangkat nyata.",
      en: "Khairuramdhani (Khai) is an AI/ML Engineer, Mobile Developer, and Mechanical Designer, as well as a Computer Engineering student at Universitas Brawijaya. His main focus and interest are Computer Vision as well as mechanical and 3D design, while also being proficient in machine learning, data, IoT/embedded systems, and mobile development. He primarily works with Python and C++, develops mobile applications with Flutter, and carries out projects end to end, from data to deployment on real devices." },

    { k: ["skill", "keahlian", "kemampuan", "bisa apa", "kuasai", "teknologi", "stack", "tools", "bahasa pemrograman", "programming", "framework", "tech"],
      id: "Keahlian utama Khai:\n• Bahasa Pemrograman: Python, C++, Dart, JavaScript\n• AI/ML: PyTorch, TensorFlow, scikit-learn, YOLO, CNN, SVM\n• Computer Vision: OpenCV, deteksi real-time, segmentasi, on-device (TF Lite)\n• Mobile: Flutter, Firebase, Supabase\n• Embedded/IoT: ESP32, Arduino, FreeRTOS, sensor, RTC\n• Mechanical Design & CAD: Autodesk Fusion 360, 3D design, sheet metal design, gambar teknik\n• Data: pandas, NumPy, matplotlib, seaborn\n• Tools: Git, Linux, Anaconda, Weights & Biases",
      en: "Khai's core skills:\n• Programming Languages: Python, C++, Dart, JavaScript\n• AI/ML: PyTorch, TensorFlow, scikit-learn, YOLO, CNN, SVM\n• Computer Vision: OpenCV, real-time detection, segmentation, on-device (TF Lite)\n• Mobile: Flutter, Firebase, Supabase\n• Embedded/IoT: ESP32, Arduino, FreeRTOS, sensors, RTC\n• Mechanical Design & CAD: Autodesk Fusion 360, 3D design, sheet metal design, technical drawing\n• Data: pandas, NumPy, matplotlib, seaborn\n• Tools: Git, Linux, Anaconda, Weights & Biases" },
    ...
    { k: ["robotiik", "chassis", "fusion", "fusion 360", "sheet metal", "mekanik", "mechanical", "cad", "robot berkaki", "legged robot", "bend table", "gambar teknik", "technical drawing"],
      id: "Robotiik Chassis: chassis robot berkaki untuk tim Robotiik, dikerjakan menggunakan Autodesk Fusion 360 dengan mengacu pada desain Robotis sebagai basis, kemudian disesuaikan untuk dimensi servo dan komputer onboard yang digunakan. Setiap part berupa sheet metal dengan bend table dan flat pattern untuk fabrikasi. Khai berperan sebagai PIC Mekanik dan anggota tim Computer Vision di Robotiik.",
      en: "Robotiik Chassis: the chassis for Robotiik's legged robot, developed using Autodesk Fusion 360 with reference to Robotis' original design, then adapted for the servo and onboard-computer dimensions used. Each part is designed as sheet metal with bend tables and flat patterns for fabrication. Khai serves as Mechanical PIC and a Computer Vision team member at Robotiik." },
    ...
    { k: ["computer vision", "fokus", "minat", "spesialisasi", "interest", "specialty", "suka apa", "passion"],
      id: "Minat utama Khai adalah Computer Vision serta desain mekanik dan 3D. Pada Computer Vision, ia tertarik pada deteksi real-time, segmentasi, dan inferensi on-device (TF Lite), yang menjadi benang merah pada proyek seperti CERDAS, Buah-Seru, dan PANDAI. Pada desain mekanik dan 3D, ia tertarik memodelkan dan mendesain komponen menggunakan Autodesk Fusion 360, seperti pada proyek Robotiik Chassis. Selain itu, Khai juga menguasai ML klasik, data, IoT, dan mobile.",
      en: "Khai's main interests are Computer Vision as well as mechanical and 3D design. In Computer Vision, he is drawn to real-time detection, segmentation, and on-device inference (TF Lite), a focus that runs through projects such as CERDAS, Buah-Seru, and PANDAI. In mechanical and 3D design, he enjoys modelling and designing components using Autodesk Fusion 360, as seen in the Robotiik Chassis project. He is also proficient in classic ML, data, IoT, and mobile development." },

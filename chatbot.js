...
(function () {
  ...
  var ENTRIES = [
    ...
    { k: ["pengalaman", "experience", "kerja", "work", "magang", "intern", "internship", "aitf", "komdigi", "job", "career", "asisten", "teaching assistant"],
      id: "Pengalaman Khai:\n• AI Engineer Intern @ AITF (Feb–Jun 2026) — program nasional kolaborasi Komdigi × Universitas Brawijaya. Bikin pipeline anotasi data semi-otomatis pakai Vision-Language Models, pipeline deep learning end-to-end untuk Computer Vision, dan fine-tuning LLM.\n• Asisten Praktikum — Struktur Data & Algoritma serta Pemrograman Dasar (2024/2025) di FILKOM UB (ngajar lab C++, review tugas).",
      en: "Khai's experience:\n• AI Engineer Intern @ AITF (Feb–Jun 2026) — a national program, a Komdigi × Universitas Brawijaya collaboration. Built a semi-automatic data-annotation pipeline with Vision-Language Models, end-to-end deep-learning pipelines for Computer Vision, and fine-tuned LLMs.\n• Teaching Assistant — Data Structures & Algorithms and Basic Programming (2024/2025) at FILKOM UB (C++ labs, assignment reviews)." },
